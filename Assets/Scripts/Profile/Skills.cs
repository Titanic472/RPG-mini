...
public class Skills : MonoBehaviour
{
    ...
    public int DMG_1_1_Accuracy, DMG_1Perc_1_Accuracy, HP_1Perc_1_Accuracy, EV_4_ACC_4_1_Accuracy, HP_25_1_Accuracy, DMG_2Perc_1_Accuracy, HP_2Perc_1_Accuracy, DMG_2_1_Accuracy, DMG_2_2_Accuracy, DMG_2Perc_2_Accuracy, DMG_3_1_Accuracy, EV_10_ACC_10_1_Accuracy, HP_30_1_Accuracy, EV_10_ACC_10_2_Accuracy, EV_6_ACC_6_1_Accuracy, DMG_3_2_Accuracy, DMG_5Perc_1_Accuracy, HP_5Perc_1_Accuracy, CritChance_2Perc_1_Accuracy, ACC_10_1_Accuracy, CritDamage_3Perc_1_Accuracy, CritChance_2Perc_2_Accuracy, CritChance_2Perc_3_Accuracy, CritDamage_3Perc_2_Accuracy, HP_30_2_Accuracy, HP_2Perc_2_Accuracy, CritChance_4Perc_1_Accuracy, HP_25_2_Accuracy, CritDamage_5Perc_1_Accuracy, ACC_10_3_Accuracy, CritDamage_5Perc_2_Accuracy, CritDamage_10Perc_1_Accuracy, ACC_10_4_Accuracy, HP_40_1_Accuracy, ACC_10_2_Accuracy, EV_10_ACC_10_3_Accuracy;
    ...
    public float Shield_MagicDefence = 0, Shield_DamageReturn = 0, Shield_NoStaminaUsageChance = 0, Shield_DamageBoost = 0, DMGCapOverdamage = 1.5f, Crit_Damage = 0.2f, DamageModifier = 1f, Shield_DamageResistance = 0, Shield_AvoidChance = 0;
    ...
    public void Skilltree_Damage(){
        player.BaseDamage = player.Level + 1 + DMG_1_1_Accuracy*2 + DMG_2_1_Accuracy*4 + DMG_2_2_Accuracy*4 + DMG_3_1_Accuracy*5 + DMG_3_2_Accuracy*5;
    }
    ...
    public void Skilltree_CritDamage(){
        Crit_Damage = 0.2f + (CritDamage_3Perc_1_Accuracy*3 + CritDamage_3Perc_2_Accuracy*3 + CritDamage_5Perc_1_Accuracy*5 + CritDamage_5Perc_2_Accuracy*5 + CritDamage_10Perc_1_Accuracy*10)/100f;
    }
    ...
    public void ChangeBranch(string BranchNameToSet){
        switch(BranchNameToSet){
            ...
            case "Accuracy":
                ...
                BranchInformationText3.text  = "<sprite=\"Skills\" name=\"Damage\">" + (DMG_1_1_Accuracy*2 + DMG_2_1_Accuracy*4 + DMG_2_2_Accuracy*4 + DMG_3_1_Accuracy*5 + DMG_3_2_Accuracy*5);
