...
public class Data
{
    public int[] intPlayer = new int[230], intPlayerItems = new int[21], intSkillTree = new int[169], intGame = new int[1], intPlayerXP = new int[50], intActiveSkills = new int[4];
