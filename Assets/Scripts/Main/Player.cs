...
public class Player : Entity
{
    ...
    public override void UpdateAllStats(){
        ...
        MaxMana = Convert.ToInt32(Math.Ceiling(ManaModifier*(Hat.GetComponent<Item>().Mana + Chestplate.GetComponent<Item>().Mana + Boots.GetComponent<Item>().Mana + LeftHand.GetComponent<Item>().Mana + RightHand.GetComponent<Item>().Mana + Trinket1.GetComponent<Item>().Mana + Trinket2.GetComponent<Item>().Mana + BaseMana)));
